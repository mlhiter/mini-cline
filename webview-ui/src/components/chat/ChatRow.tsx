      ...
      case 'listCodeDefinitionNames':
        return (
          <>
            ...
            <CodeAccordian code={tool.content!} path={tool.path!} isExpanded={isExpanded} onToggleExpand={onToggleExpand} />
          </>
        )
      case 'searchFiles':
        return (
          ...
          return (
            <>
              <div style={{ paddingTop: 0 }}>
                ...
                <CodeAccordian code={message.text} language="json" isExpanded={true} onToggleExpand={onToggleExpand} />
              </div>
            </>
          )
        case 'text':
        ...
        case 'user_feedback':
          return (
            <div
              ...
              {message.images && message.images.length > 0 && <Thumbnails images={message.images} style={{ marginTop: '8px' }} />}
            </div>
          )
          ...
          return (
            <>
              <div
                ...
                <div>
                  Cline won't be able to view the command's output. Please update VSCode (<code>CMD/CTRL + Shift + P</code> →
