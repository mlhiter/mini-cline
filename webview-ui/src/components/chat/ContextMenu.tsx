        ...
        {filteredOptions.map((option, index) => (
          <div
            ...
            style={{
              ...
              color: index === selectedIndex && isOptionSelectable(option) ? 'var(--vscode-quickInputList-focusForeground)' : '',
              borderBottom: '1px solid var(--vscode-editorGroup-border)',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'space-between',
              backgroundColor:
                index === selectedIndex && isOptionSelectable(option) ? 'var(--vscode-quickInputList-focusBackground)' : '',
            }}
