...
export const CheckmarkControl = ({ messageTs, isCheckpointCheckedOut }: CheckmarkControlProps) => {
  ...
  return (
    <Container isMenuOpen={showRestoreConfirm} $isCheckedOut={isCheckpointCheckedOut} onMouseLeave={handleControlsMouseLeave}>
      ...
      />
      <Label $isCheckedOut={isCheckpointCheckedOut}>{isCheckpointCheckedOut ? 'Checkpoint (restored)' : 'Checkpoint'}</Label>
            ...
            createPortal(
              <RestoreConfirmTooltip
                ...
                <RestoreOption>
                  ...
                  <p>
                    Restores your project's files back to a snapshot taken at this point (use "Compare" to see what will be
                    reverted)
                  </p>
                </RestoreOption>
                <RestoreOption>
